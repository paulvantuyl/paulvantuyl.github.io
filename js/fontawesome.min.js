!function() {
    ...
    function u(t) {
        ...
        return f += s && Q ? "translate(" + (n.x / pt - r / 2) + "em, " + (n.y / pt - a / 2) + "em) " : s ? "translate(calc(-50% + " + n.x / pt + "em), calc(-50% + " + n.y / pt + "em)) " : "translate(" + n.x / pt + "em, " + n.y / pt + "em) ", 
        f += "scale(" + n.size / pt * (n.flipX ? -1 : 1) + ", " + n.size / pt * (n.flipY ? -1 : 1) + ") ", 
        f += "rotate(" + n.rotate + "deg) ";
    }
    function m(t) {
        var n, e = t.icons, i = e.main, a = e.compose, o = t.prefix, s = t.iconName, f = t.transform, l = t.symbol, c = t.title, u = t.extra, m = a.found ? a : i, d = m.width, g = m.height, p = "fa-w-" + Math.ceil(d / g * 16), h = [ gt.replacementClass, s ? gt.familyPrefix + "-" + s : "", p ].concat(u.classes).join(" "), v = {
            children: [],
            attributes: ct({}, u.attributes, (n = {}, lt(n, $, ""), lt(n, "data-prefix", o), 
            lt(n, "data-icon", s), lt(n, "class", h), lt(n, "role", "img"), lt(n, "xmlns", "http://www.w3.org/2000/svg"), 
    ...
    function h() {
        return !0 === gt.autoReplaceSvg ? St.replace : St[gt.autoReplaceSvg] || St.replace;
    }
    function v(t, n) {
        var e = "function" == typeof n ? n : Nt;
        0 === t.length ? e() : (q.requestAnimationFrame || function(t) {
            return t();
        })(function() {
            var n = h(), r = Et.begin("mutate");
            t.map(n), r(), e();
        });
    }
    function b(t) {
    ...
    function y(t) {
        if (G) {
            var n = t.treeCallback, e = t.nodeCallback, r = t.pseudoElementsCallback, a = new G(function(t) {
                Tt || i(t).forEach(function(t) {
                    "childList" === t.type && t.addedNodes.length > 0 && !p(t.addedNodes[0]) && (gt.searchPseudoElements && r(t.target), 
                    n(t.target)), "attributes" === t.type && "class" === t.attributeName && t.target.parentNode && gt.searchPseudoElements && r(t.target.parentNode), 
                    "attributes" === t.type && p(t.target) && ~at.indexOf(t.attributeName) && e(t.target);
                });
            });
            U.getElementsByTagName && a.observe(U.getElementsByTagName("body")[0], {
                childList: !0,
                attributes: !0,
                characterData: !0,
                subtree: !0
    ...
    function A(t) {
        var n = Yt(t), e = n.iconName, r = n.prefix, i = n.rest, a = Lt(t), o = qt(t), s = Ut(t), f = Gt(t), l = Jt(t);
        return {
            iconName: e,
    ...
    function C(t, n) {
        ...
        } else if (t && n && !gt.showMissingIcons) throw new z("Icon is missing for prefix " + n + " with icon name " + t);
        return e;
    }
    function E(t, n) {
    ...
    function S(t) {
        var n = A(t);
        return ~n.extra.classes.indexOf(en) ? N(t, n) : E(t, n);
    }
    function T(t) {
        ...
        b(function() {
            i(t.querySelectorAll("*")).reduce(function(t, n) {
                [ ":before", ":after" ].forEach(function(t) {
                    var e = q.getComputedStyle(n, t), r = e.getPropertyValue("font-family").match(rn), a = i(n.children).filter(function(n) {
                        return n.getAttribute(tt) === t;
                    })[0];
                    if (!r && a && a.remove(), r && !a) {
                        var o = e.getPropertyValue("content"), s = U.createElement("i");
                        s.setAttribute("class", "" + an[r[1]]), s.setAttribute(tt, t), s.innerText = 3 === o.length ? o.substr(1, 1) : o, 
    ...
    function L(t) {
        ...
        }, o = Object.keys(nn), s = [ "." + en + ":not([" + $ + "])" ].concat(o.map(function(t) {
            return "." + t + ":not([" + $ + "])";
        })).join(", ");
        if (0 !== s.length) {
            ...
            if (f.length > 0) {
                ...
                var l = Et.begin("onTree"), c = f.reduce(function(t, n) {
                    try {
                        ...
                        et || t instanceof z && console.error(t);
                    }
                    return t;
                }, []);
                l(), v(c, function() {
    ...
    function W(t) {
        ...
        if (r) return M(mn.definitions, e, r) || M(Ot.packs, e, r);
    }
    ...
    var Y = (R.navigator || {}).userAgent, V = void 0 === Y ? "" : Y, q = R, U = X, G = D, J = H, K = !!q.document, Q = ~V.indexOf("MSIE") || ~V.indexOf("Trident/"), Z = 16, $ = "data-fa-processed", tt = "data-fa-pseudo-element", nt = "fontawesome-i2svg", et = function() {
        try {
            return !1;
        } catch (t) {
            return !1;
    ...
    _t.___FONT_AWESOME___ || (_t.___FONT_AWESOME___ = {}), _t.___FONT_AWESOME___.packs || (_t.___FONT_AWESOME___.packs = {}), 
    _t.___FONT_AWESOME___.hooks || (_t.___FONT_AWESOME___.hooks = {}), _t.___FONT_AWESOME___.shims || (_t.___FONT_AWESOME___.shims = []);
    var Ot = _t.___FONT_AWESOME___, Mt = function() {}, At = gt.measurePerformance && J && J.mark && J.measure ? J : {
        mark: Mt,
        measure: Mt
    }, zt = 'FA "5.0.0-rc4"', Ct = function(t) {
        At.mark(zt + " " + t + " ends"), At.measure(zt + " " + t, zt + " " + t + " begins", zt + " " + t + " ends");
    }, Et = {
        begin: function(t) {
            return At.mark(zt + " " + t + " begins"), function() {
                return Ct(t);
            };
        },
        end: Ct
        ...
        nest: function(t) {
            var n = t[0], e = t[1];
            if (~i(n.classList).indexOf(gt.replacementClass)) return St.replace(t);
        ...
        var i, a, o, s = Object.keys(t), f = s.length, l = void 0 !== r ? jt(n, r) : n;
        for (void 0 === e ? (i = 1, o = t[s[0]]) : (i = 0, o = e); i < f; i++) o = l(o, t[a = s[i]], a, t);
        return o;
    }, It = Ot.packs, Ft = Ot.shims, Wt = {}, Bt = {}, Rt = {}, Xt = function() {
        var t = function(t) {
            return Pt(It, function(n, e, r) {
                return n[r] = Pt(e, t, {}), n;
            }, {});
        };
        Wt = t(function(t, n, e) {
    ...
    var Dt = Ot.packs, Ht = function() {
        ...
        var n = t.getAttribute("data-prefix"), e = t.getAttribute("data-icon"), r = O(i(t.classList));
    ...
    }, nn = Ot.packs, en = "fa-layers-text", rn = /Font Awesome 5 (Solid|Regular|Light|Brands)/, an = {
        Solid: "fas",
        Regular: "far",
        Light: "fal",
        Brands: "fab"
    }, on = [], sn = (U.documentElement.doScroll ? /^loaded|^c/ : /^loaded|^i|^c/).test(U.readyState);
    sn || U.addEventListener("DOMContentLoaded", function t() {
        U.removeEventListener("DOMContentLoaded", t), sn = 1, on.map(function(t) {
            return t();
        });
    });
    var fn = function(t) {
        U && (sn ? setTimeout(t, 0) : on.push(t));
    }, ln = function(t) {
        ...
        var t = "svg-inline--fa", n = gt.familyPrefix, e = gt.replacementClass, r = ln;
        if ("fa" !== n || e !== t) {
            var i = new RegExp("\\.fa\\-", "g"), a = new RegExp("\\." + t, "g");
            r = r.replace(i, "." + n + "-").replace(a, "." + e);
        }
        return r;
    }, un = !1, mn = new (function() {
        function t() {
        ...
        dom: {
            i2svg: function() {
                ...
                I();
                var n = t.node, e = void 0 === n ? U : n, r = t.callback, i = void 0 === r ? function() {} : r;
                gt.searchPseudoElements && T(e), L(e, i);
            },
            styles: cn,
        ...
        icon: function(t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, e = n.transform, i = void 0 === e ? ht : e, a = n.symbol, o = void 0 !== a && a, s = n.compose, f = void 0 === s ? null : s, l = n.title, c = void 0 === l ? null : l, u = n.classes, d = void 0 === u ? [] : u, g = n.attributes, p = void 0 === g ? {} : g, h = n.style, v = void 0 === h ? {} : h, b = t.icon ? t : W(t);
            if (b) {
                var y = b.prefix, w = b.iconName, x = b.icon;
                return F(ct({
                    type: "icon"
                }, t), function() {
                    return I(), gt.autoA11y && (c ? p["aria-labelledby"] = gt.replacementClass + "-title-" + r() : p["aria-hidden"] = "true"), 
                    m({
                        icons: {
                            main: P(x),
                            compose: f ? P(f.icon) : {
        ...
        text: function(t) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, e = n.transform, r = void 0 === e ? ht : e, i = n.title, a = void 0 === i ? null : i, o = n.classes, s = void 0 === o ? [] : o, f = n.attributes, l = void 0 === f ? {} : f, c = n.style, u = void 0 === c ? {} : c;
            return F({
                type: "text",
                content: t
            }, function() {
    ...
    Object.defineProperty(dn, "config", {
        get: function() {
        ...
        var t = function() {
            gt.autoReplaceSvg && dn.dom.i2svg({
                node: U
            });
        };
        K && (q.FontAwesome || (q.FontAwesome = dn), fn(function() {
            Object.keys(Ot.packs).length > 0 && t(), gt.observeMutations && "function" == typeof MutationObserver && y({
                treeCallback: L,
                nodeCallback: j,
            ...
            addPack: function(n, e) {
                Ot.packs[n] = ct({}, Ot.packs[n] || {}, e), Xt(), t();
            },
            addShims: function(n) {
                var e;
                (e = Ot.shims).push.apply(e, mt(n)), Xt(), t();
            }
        });
    });
}();